...
file_path = "Fixed_Standardized_Global_Indicators.csv"  # Update with your actual file name
df = pd.read_csv(file_path)
...
encoded_file_path = "Encoded_Standardized_Global_Indicators.csv"
df.to_csv(encoded_file_path, index=False)

print(f"✅ Encoded and standardized dataset saved as {encoded_file_path}")

from google.colab import files

# Download the encoded and standardized dataset
files.download("Encoded_Standardized_Global_Indicators.csv")